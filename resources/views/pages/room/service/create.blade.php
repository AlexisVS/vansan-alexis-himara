<x-app-layout>
  ...
  <div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <section>
        <x-form.form action='/dashboard/room/service' method='POST' enctype title='Add room service'>
          <x-form.text name="room_service_text" placeholder="Name of the service" />
          <div class="col-start-1 col-span-full md:col-start-2 md:col-span-4">
          <p class="text-yellow-500 font-mono">If you choose span card, the icon ( i_class ) in the room card don't show up</p>
          </div>
          <x-form.text name="span_card" placeholder="text in the card" />
          <x-form.fa-select name="i_class" :icons="$icons" />
          <x-form.text name="similar_rooms_room_services_i_data_content" placeholder="content of popover in the icon card" />
          <x-form.text name="similar_rooms_room_services_i_data_title" placeholder="title of popover in the icon card" />
        </x-form.form>
