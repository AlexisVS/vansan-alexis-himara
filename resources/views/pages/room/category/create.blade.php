<x-app-layout>
  ...
  <div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <section>
        <x-form.form action='/dashboard/room/category' method='POST' enctype title='Add room category'>
          <x-form.text name="value" placeholder="Name of room category" />
          <x-form.text name="text" placeholder="description of room category" />
        </x-form.form>
