  ...
  <div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <section>
        ...
        <x-form.form action='/dashboard/room/category/{{ $edit->id }}' method='PUT' enctype title='Edition room category {{ $edit->text }}'
          subtitle="All text in your page">
          <x-form.text name="value" :text="$edit->value" />
