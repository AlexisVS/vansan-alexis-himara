<x-app-layout>
  <x-slot name="header">
    <div class="flex w-full justify-between items-center space-x-12">
      ...
      <div class="flex items-center space-x-4">
        <a href="/dashboard/room/create" class="px-6 py-3 mr-2 mt-3 bg-himaraBlue-500 text-white shadow rounded-md hover:bg-himaraBlue-600">Add room</a>
        <a href="/dashboard/room/category" class="px-6 py-3 mr-2 mt-3 bg-himaraBlue-500 text-white shadow rounded-md hover:bg-himaraBlue-600">Categories</a>
        <a href="/dashboard/room/service" class="px-6 py-3 mr-2 mt-3 bg-himaraBlue-500 text-white shadow rounded-md hover:bg-himaraBlue-600">Services</a>
      </div>
  ...
  <div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      <section>
        ...
        <x-table.table :columns="collect(['id', 'name', 'price', 'sq_mt', 'id', 'id'])" crud-uri="/dashboard/room/" :data-tables="$rooms" numberHeadActions="" />
