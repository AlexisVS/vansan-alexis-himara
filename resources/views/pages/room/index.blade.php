    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <section>
                ...
                <x-description.description image-path="/images/" :columns="collect($static_room->first())->keys()"
                    title='Static page room body' {{-- subtitle='Le sous titre mon composant description' --}}
                    :data-tables="collect($static_room->take(1))" edit-uri="/dashboard/room/edit-static"
                    uri-static='true' />

                <x-description.description image-path="/images/"
                    :columns="collect($static_room_sidebar->first())->keys()" title='Static page room sidebar' {{--
                    subtitle='Le sous titre mon composant description' --}}
                    :data-tables="collect($static_room_sidebar->take(1))" edit-uri="/dashboard/room/edit-static-sidebar"
                    uri-static='true' />
                ...
                <div class="mb-28 mt-8 bg-himaraGold-500 shadow overflow-hidden sm:rounded-lg">
                    <div class="flex items-center justify-between w-full pr-5">
                        ...
                        <a href="/dashboard/room/{{ $room->id }}/edit">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 text-gray-100 hover:text-gray-200"
                    ...
                    <div class="border-t border-gray-200">
                        ...
                        <dl class="">
                            ...
                            <div
                                ...
                                {{-- {{ dd(strtolower($room->categories->value)) }} --}}
                                <dd class="mt-1 text-sm text-gray-400 sm:mt-0 sm:col-span-2">
                                    <img class="max-w-xs max-h-32" src="{{ asset("/images/rooms/" . strtolower($room->categories->value) . '/' . $image->image_img )}}" alt="">
                                </dd>
                            </div>
                            @endforeach
                        </dl>
