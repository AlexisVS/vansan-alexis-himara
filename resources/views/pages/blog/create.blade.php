  ...
  <div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <section>
        ...
        <x-form.form action='/dashboard/blog' method='POST' enctype title='Add post'>
          <x-form.upload name="figure_link_img" />
          <x-form.text name="title_text" placeholder="Post title" />
          <x-form.textarea name="text" placeholder="description of post" />
          <x-form.upload name="author_img" />
          <x-form.text name="author_text" placeholder="Name of author" />
          <x-form.fa-select name="date_i_class" title="" :icons="$icons"  />
          <x-form.text name="date_text" placeholder="description of member" />
          <x-form.fa-select name="comments_i_class" title="" :icons="$icons" />
          <x-form.text name="comments_text" placeholder="description of member" />
