  ...
  <div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <section>
        ...
        <x-form.form action='/dashboard/blog/edit-static-title' method='PUT' enctype title='Edition static blog title' subtitle="All text in your page">
          <x-form.upload name="img" />
          <x-form.text name="title" :text="$edit->title" />
          <x-form.text name="li" :text="$edit->li" />
        </x-form.form>
