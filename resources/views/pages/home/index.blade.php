  ...
  <div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      <section id="homeSlider">
        ...
        <x-description.description image-path="/images/slider/" :columns="collect($sliders->first())->keys()" title='First Slide' subtitle='Description' :data-tables="collect($sliders->take(1))" edit-uri="/dashboard/home/slider/" />

        <x-description.description image-path="/images/slider/" :columns="collect(['id', 'mainImage_img', 'layer1_text', 'layer2_text', 'order'])" title='Second Slide' subtitle='Description' :data-tables="collect($sliders->skip(1)->take(1))" edit-uri="/dashboard/home/slider/" />

        <x-description.description image-path="/images/slider/" :columns="collect(['id', 'mainImage_img', 'layer1_text', 'layer2_text', 'order'])" title='third Slide' subtitle='Description' :data-tables="collect($sliders->skip(2)->take(1))" edit-uri="/dashboard/home/slider/" />

        @if($sliders->count() > 3)
        <x-table.table image-path="/images/slider/" :columns="collect(['mainImage_img', 'layer1_text', 'layer2_text', 'order', '', ''])" crud-uri="/dashboard/home/slider/" :data-tables="collect($sliders->skip(3)) " numberHeadActions="" />
      ...
      <section id="homeProviders">
        ...
        <x-table.table image-path="/images/providers" :columns="collect($providers->first())->keys()" crud-uri="/dashboard/home/provider" :data-tables="$providers" numberHeadActions="2" show="" />
      ...
      <section id="homeServices">
        ...
        <x-table.table image-path="/images/services" :columns="collect($services->first())->keys()" crud-uri="/dashboard/home/service" :data-tables="$services" numberHeadActions="2" show="" />
      ...
      <section id="homeTestimonial">
        ...
        <x-table.table image-path="/images/users" :columns="collect($testimonials->first())->keys()" crud-uri="/dashboard/home/testimonial" :data-tables="$testimonials" numberHeadActions="" />
      ...
      <section id="homeRestaurant">
        ...
        <x-table.table image-path="/images/restaurant" :columns="collect($restaurants->first())->keys()" crud-uri="/dashboard/home/restaurant" :data-tables="$restaurants" numberHeadActions="2" show="" />
