  ...
  <div class="py-12">
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      <section>
        ...
        <x-form.form action="/dashboard/home/provider" method='POST' enctype title="Create a provider" subtitle="">
          <x-form.text name="provider_href" placeholder="Website link of provider" text="" />
