  ...
  <div class="py-12">
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      <section>
        ...
        <x-form.form action="/dashboard/home/restaurant" method='POST' enctype title="Add a meal" subtitle="">
          <x-form.upload name="img" />
          <x-form.text name="title_name" placeholder="Titile of the meal" text="" />
          <x-form.text name="title_price" placeholder="Price ex: 9.99" text="" />
          <x-form.text name="text" placeholder="Description" text="" />
        </x-form.form>
