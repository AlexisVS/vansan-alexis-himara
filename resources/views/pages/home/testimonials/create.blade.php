  ...
  <div class="py-12">
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      <section>
        ...
        <x-form.form action="/dashboard/home/testimonial" method='POST' enctype title="Create a provider" subtitle="">
          <x-form.upload name="img" />
          <x-form.text name="author_name"  placeholder="Name of author"/>
          <x-form.text name="author_location"  placeholder="Athor location ex: Madrid / Spain"/>
          <x-form.select name="rating" :options="collect([1,2,3,4,5])" />
          <x-form.fa-select name="rating_i_class" title="" :icons="$icons" />
          <x-form.textarea name="text" placeholder="Text" />
        </x-form.form>
