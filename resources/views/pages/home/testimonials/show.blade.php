    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <section>
                ...
                <x-description.description image-path="/images/users/" :columns="collect($show)->keys()"
                    title='User comment' subtitle='All description about user comment'
                    :data-tables="collect([$show])" edit-uri="/dashboard/home/testimonial/{{ $show->id }}/edit"
                    uri-static='true' />
