  ...
  <div id="homeStaticEditTop" class="py-12">
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      <section id="homeStaticEditBookingForm">
        ...
        <x-form.form action='/dashboard/home/edit-static-booking-form' method='PUT' enctype title='Edition static contact' subtitle="All text in your page">
      ...
      <section id="homeStaticEditRoom">
        ...
        <x-form.form action='/dashboard/home/edit-static-room' method='PUT' enctype title='Edition static contact' subtitle="All text in your page">
      ...
      <section id="homeStaticEditServices">
        ...
        <x-form.form action='/dashboard/home/edit-static-service' method='PUT' enctype title='Edition static contact' subtitle="All text in your page">
      ...
      <section id="homeStaticEditGallery">
        ...
        <x-form.form action='/dashboard/home/edit-static-gallery' method='PUT' enctype title='Edition static contact' subtitle="All text in your page">
      ...
      <section id="homeStaticEditTestimonial">
        ...
        <x-form.form action='/dashboard/home/edit-static-testimonial' method='PUT' enctype title='Edition static contact' subtitle="All text in your page">
      ...
      <section id="homeStaticEditNew">
        ...
        <x-form.form action='/dashboard/home/edit-static-new' method='PUT' enctype title='Edition static contact' subtitle="All text in your page">
      ...
      <section id="homeStaticEditContact">
        ...
        <x-form.form action='/dashboard/home/edit-static-contact' method='PUT' enctype title='Edition static contact' subtitle="All text in your page">
