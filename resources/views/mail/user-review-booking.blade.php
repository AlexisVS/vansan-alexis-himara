                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td class="subhead" style="padding: 0 0 0 3px;">
                          Please gift us a review for our welcome
                        </td>
                      </tr>
          ...
          <tr>
            <td class="innerpadding borderbottom">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td class="bodycopy">
                    Please gift us a review for our welcome a this link below:
                    <a class="link" href="http://127.0.0.1:8000/booking-form-store-review-mail/{{ $booking->user_id }}/{{ $booking->room }}">Post our review</a>
                  </td>
                </tr>
              </table>
            </td>
