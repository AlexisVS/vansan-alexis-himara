...
<div class="absolute top-4 left-1/2 transform -translate-x-1/2 opacity-100 transition-opacity duration-700">
  ...
  <div class="w-full px-2 py-4 overflow-x-auto text-center whitespace-no-wrap rounded-md" role="alert">
    ...
    <div class="relative inline-flex w-full max-w-sm ml-2 overflow-hidden bg-green-500 rounded shadow-sm hover:bg-green-600 hover:shadow-lg">
...
<div class="absolute top-4 left-1/2 transform -translate-x-1/2 opacity-100 transition-opacity duration-700">
  ...
  <div class="w-full px-2 py-4 overflow-x-auto text-center whitespace-no-wrap rounded-md" role="alert">
    ...
    <div class="relative inline-flex w-full max-w-sm ml-2 overflow-hidden bg-red-500 rounded shadow-sm hover:shadow-lg hover:bg-red-600">
      ...
      <div class="px-4 py-2 text-left">
        ...
        <p class="mb-1 text-sm leading-none text-white">{{ $error }}</p>
...
<div class="absolute top-4 left-1/2 transform -translate-x-1/2 opacity-100 transition-opacity duration-700">
  ...
  <div class="w-full px-2 py-4 overflow-x-auto text-center whitespace-no-wrap rounded-md" role="alert">
    ...
    <div class="relative inline-flex w-full max-w-sm ml-2 overflow-hidden bg-yellow-500 rounded shadow-sm hover:shadow-lg hover:bg-yellow-600">
...
<div class="absolute top-4 left-1/2 transform -translate-x-1/2 opacity-100 transition-opacity duration-700">
  ...
  <div class="w-full px-2 py-4 overflow-x-auto text-center whitespace-no-wrap rounded-md" role="alert">
    ...
    <div class="relative inline-flex w-full max-w-sm ml-2 overflow-hidden bg-blue-500 rounded shadow-sm hover:bg-blue-600 hover:shadow-lg">
