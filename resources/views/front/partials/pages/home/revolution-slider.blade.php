...
<div id="rev-slider-1" class="rev_slider gradient-slider" style="display:none" data-version="5.4.5">
  <ul>
    ...
    <li data-transition="crossfade">
      <!-- MAIN IMAGE -->
      <img src="{{ asset('images/slider/' . $revolutionSliders[0]->mainImage) }}" alt="Image" title="Image"
      ...
      <div class="tp-caption" data-x="center" data-hoffset="128" data-y="480" data-voffset=""
        ...
        <a class="btn" href="{{ $revolutionSliders[0]->layer4_href }}">
          <i class="fa {{ $revolutionSliders[0]->layer4_i_class }}"
            aria-hidden="true"></i>{{ $revolutionSliders[0]->layer4_text }}</a>
      </div>
      <!-- LAYER NR. 5 -->
    ...
    <li data-transition="crossfade">
      <!-- MAIN IMAGE -->
      <img src="{{ asset('images/slider/' . $revolutionSliders[1]->mainImage) }}" alt="Image" title="Image"
        data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10"
        class="rev-slidebg" data-no-retina="">
      <!-- LAYER NR. 1 -->
    ...
    <li data-transition="crossfade">
      <!-- MAIN IMAGE -->
      <img src="{{ asset('images/slider/' . $revolutionSliders[2]->mainImage) }}" alt="Image" title="Image"
        data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10"
        class="rev-slidebg" data-no-retina="">
      <!-- LAYER NR. 1 -->
    ...
    @foreach ($revolutionSliders as $revolutionSlider)
      @if ($loop->iteration > 3)
        <li data-transition="crossfade">
          <!-- MAIN IMAGE -->
          <img src="{{ asset('images/slider/' . $revolutionSlider->mainImage) }}" alt="Image" title="Image"
            data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10"
            class="rev-slidebg" data-no-retina="">
          <!-- LAYER NR. 1 -->
          <div class="tp-caption tp-resizeme" data-x="center" data-hoffset="" data-y="305" data-voffset=""
