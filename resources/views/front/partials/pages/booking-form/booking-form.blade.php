  ...
  <div class="row">
    <div class="col-md-6">
      <div class="form-group">
        ...
        <input name="booking-name" type="text" class="form-control" placeholder="{{ $static_bookingForm->form_name_placeholder }}">
      </div>
    </div>
    <div class="col-md-6">
      <div class="form-group">
        <label>{{ $static_bookingForm->form_email_text }}</label>
        <input class="form-control" name="booking-email" type="email" placeholder="{{ $static_bookingForm->form_email_placeholder }}">
      </div>
    </div>
    <div class="col-md-6">
      <div class="form-group">
        <label>{{ $static_bookingForm->form_phone_text }}</label>
        <input name="booking-phone" type="text" class="form-control" placeholder="{{ $static_bookingForm->form_phone_placeholder }}">
      </div>
    </div>
    <div class="col-md-6">
      <div class="form-group">
        ...
        <select name="booking-country" class="form-control" title="{{ $static_bookingForm->select_title }}"
          ...
          <option value="{{ $static_bookingFormLand->American_Samoa }}">{{ $static_bookingFormLand->American_Samoa }}</option>
          ...
          <option value="{{ $static_bookingFormLand->Antigua_Barbuda }}">{{ $static_bookingFormLand->Antigua_Barbuda }}</option>
          ...
          <option value="{{ $static_bookingFormLand->Bosnia_Herzegovina }}">{{ $static_bookingFormLand->Bosnia_Herzegovina }}</option>
          ...
          <option value="{{ $static_bookingFormLand->British_Indian_Ocean_Ter }}">{{ $static_bookingFormLand->British_Indian_Ocean_Ter }}</option>
          ...
          <option value="{{ $static_bookingFormLand->Burkina_Faso }}">{{ $static_bookingFormLand->Burkina_Faso }}</option>
          ...
          <option value="{{ $static_bookingFormLand->Canary_Islands }}">{{ $static_bookingFormLand->Canary_Islands }}</option>
          <option value="{{ $static_bookingFormLand->Cape_Verde }}">{{ $static_bookingFormLand->Cape_Verde }}</option>
          <option value="{{ $static_bookingFormLand->Cayman_Islands }}">{{ $static_bookingFormLand->Cayman_Islands }}</option>
          <option value="{{ $static_bookingFormLand->Central_African_Republic }}">{{ $static_bookingFormLand->Central_African_Republic }}</option>
          <option value="{{ $static_bookingFormLand->Chad }}">{{ $static_bookingFormLand->Chad }}</option>
          <option value="{{ $static_bookingFormLand->Channel_Islands }}">{{ $static_bookingFormLand->Channel_Islands }}</option>
          ...
          <option value="{{ $static_bookingFormLand->Christmas_Island }}">{{ $static_bookingFormLand->Christmas_Island }}</option>
          <option value="{{ $static_bookingFormLand->Cocos_Island }}">{{ $static_bookingFormLand->Cocos_Island }}</option>
          ...
          <option value="{{ $static_bookingFormLand->Cook_Islands }}">{{ $static_bookingFormLand->Cook_Islands }}</option>
          <option value="{{ $static_bookingFormLand->Costa_Rica }}">{{ $static_bookingFormLand->Costa_Rica }}</option>
          <option value="{{ $static_bookingFormLand->Cote_DIvoire }}">{{ $static_bookingFormLand->Cote_DIvoire }}</option>
          ...
          <option value="{{ $static_bookingFormLand->Czech_Republic }}">{{ $static_bookingFormLand->Czech_Republic }}</option>
          ...
          <option value="{{ $static_bookingFormLand->Dominican_Republic }}">{{ $static_bookingFormLand->Dominican_Republic }}</option>
          ...
          <option value="{{ $static_bookingFormLand->Equatorial_Guinea }}">{{ $static_bookingFormLand->Equatorial_Guinea }}</option>
          ...
          <option value="{{ $static_bookingFormLand->Falkland_Islands }}">{{ $static_bookingFormLand->Falkland_Islands }}</option>
          <option value="{{ $static_bookingFormLand->Faroe_Islands }}">{{ $static_bookingFormLand->Faroe_Islands }}</option>
          ...
          <option value="{{ $static_bookingFormLand->French_Guiana }}">{{ $static_bookingFormLand->French_Guiana }}</option>
          <option value="{{ $static_bookingFormLand->French_Polynesia }}">{{ $static_bookingFormLand->French_Polynesia }}</option>
          <option value="{{ $static_bookingFormLand->French_Southern_Ter }}">{{ $static_bookingFormLand->French_Southern_Ter }}</option>
          ...
          <option value="{{ $static_bookingFormLand->Great_Britain }}">{{ $static_bookingFormLand->Great_Britain }}</option>
          ...
          <option value="{{ $static_bookingFormLand->Liechtenstein }}">{{ $static_bookingFormLand->Liechtenstein }}</option>
          ...
          <option value="{{ $static_bookingFormLand2->Marshall_Islands }}">{{ $static_bookingFormLand2->Marshall_Islands }}</option>
          ...
          <option value="{{ $static_bookingFormLand2->Midway_Islands }}">{{ $static_bookingFormLand2->Midway_Islands }}</option>
          ...
          <option value="{{ $static_bookingFormLand2->Netherland_Antilles }}">{{ $static_bookingFormLand2->Netherland_Antilles }}</option>
          <option value="{{ $static_bookingFormLand2->Netherlands }}">{{ $static_bookingFormLand2->Netherlands }}</option>
          <option value="{{ $static_bookingFormLand2->Nevis }}">{{ $static_bookingFormLand2->Nevis }}</option>
          <option value="{{ $static_bookingFormLand2->New_Caledonia }}">{{ $static_bookingFormLand2->New_Caledonia }}</option>
          <option value="{{ $static_bookingFormLand2->New_Zealand }}">{{ $static_bookingFormLand2->New_Zealand }}</option>
          ...
          <option value="{{ $static_bookingFormLand2->Norfolk_Island }}">{{ $static_bookingFormLand2->Norfolk_Island }}</option>
          ...
          <option value="{{ $static_bookingFormLand2->Palau_Island }}">{{ $static_bookingFormLand2->Palau_Island }}</option>
          ...
          <option value="{{ $static_bookingFormLand2->Papua_New_Guinea }}">{{ $static_bookingFormLand2->Papua_New_Guinea }}</option>
          ...
          <option value="{{ $static_bookingFormLand2->Phillipines }}">{{ $static_bookingFormLand2->Phillipines }}</option>
          <option value="{{ $static_bookingFormLand2->Pitcairn_Island }}">{{ $static_bookingFormLand2->Pitcairn_Island }}</option>
          ...
          <option value="{{ $static_bookingFormLand2->Puerto_Rico }}">{{ $static_bookingFormLand2->Puerto_Rico }}</option>
          <option value="{{ $static_bookingFormLand2->Qatar }}">{{ $static_bookingFormLand2->Qatar }}</option>
          <option value="{{ $static_bookingFormLand2->Republic_of_Montenegro }}">{{ $static_bookingFormLand2->Republic_of_Montenegro }}</option>
          <option value="{{ $static_bookingFormLand2->Republic_of_Serbia }}">{{ $static_bookingFormLand2->Republic_of_Serbia }}</option>
          ...
          <option value="{{ $static_bookingFormLand2->St_Barthelemy }}">{{ $static_bookingFormLand2->St_Barthelemy }}</option>
          <option value="{{ $static_bookingFormLand2->St_Eustatius }}">{{ $static_bookingFormLand2->St_Eustatius }}</option>
          <option value="{{ $static_bookingFormLand2->St_Helena }}">{{ $static_bookingFormLand2->St_Helena }}</option>
          <option value="{{ $static_bookingFormLand2->St_Kitts_Nevis }}">{{ $static_bookingFormLand2->St_Kitts_Nevis }}</option>
          ...
          <option value="{{ $static_bookingFormLand2->St_Pierre_Miquelon }}">{{ $static_bookingFormLand2->St_Pierre_Miquelon }}</option>
          <option value="{{ $static_bookingFormLand2->St_Vincent_Grenadines }}">{{ $static_bookingFormLand2->St_Vincent_Grenadines }}</option>
          ...
          <option value="{{ $static_bookingFormLand2->Samoa_American }}">{{ $static_bookingFormLand2->Samoa_American }}</option>
          <option value="{{ $static_bookingFormLand2->San_Marino }}">{{ $static_bookingFormLand2->San_Marino }}</option>
          <option value="{{ $static_bookingFormLand2->Sao_Tome_Principe }}">{{ $static_bookingFormLand2->Sao_Tome_Principe }}</option>
          <option value="{{ $static_bookingFormLand2->Saudi_Arabia }}">{{ $static_bookingFormLand2->Saudi_Arabia }}</option>
          ...
          <option value="{{ $static_bookingFormLand2->Sierra_Leone }}">{{ $static_bookingFormLand2->Sierra_Leone }}</option>
          ...
          <option value="{{ $static_bookingFormLand2->Solomon_Islands }}">{{ $static_bookingFormLand2->Solomon_Islands }}</option>
          <option value="{{ $static_bookingFormLand2->Somalia }}">{{ $static_bookingFormLand2->Somalia }}</option>
          <option value="{{ $static_bookingFormLand2->South_Africa }}">{{ $static_bookingFormLand2->South_Africa }}</option>
          ...
          <option value="{{ $static_bookingFormLand2->Switzerland }}">{{ $static_bookingFormLand2->Switzerland }}</option>
          ...
          <option value="{{ $static_bookingFormLand2->Trinidad_Tobago }}">{{ $static_bookingFormLand2->Trinidad_Tobago }}</option>
          ...
          <option value="{{ $static_bookingFormLand2->Turkmenistan }}">{{ $static_bookingFormLand2->Turkmenistan }}</option>
          <option value="{{ $static_bookingFormLand2->Turks_Caicos_Is }}">{{ $static_bookingFormLand2->Turks_Caicos_Is }}</option>
          ...
          <option value="{{ $static_bookingFormLand2->United_Arab_Erimates }}">{{ $static_bookingFormLand2->United_Arab_Erimates }}</option>
          <option value="{{ $static_bookingFormLand2->United_Kingdom }}">{{ $static_bookingFormLand2->United_Kingdom }}</option>
          <option value="{{ $static_bookingFormLand2->United_States_of_America }}">{{ $static_bookingFormLand2->United_States_of_America }}</option>
          ...
          <option value="{{ $static_bookingFormLand2->Vatican_City_State }}">{{ $static_bookingFormLand2->Vatican_City_State }}</option>
          ...
          <option value="{{ $static_bookingFormLand2->Virgin_Islands_Brit }}">{{ $static_bookingFormLand2->Virgin_Islands_Brit }}</option>
          <option value="{{ $static_bookingFormLand2->Virgin_Islands_USA }}">{{ $static_bookingFormLand2->Virgin_Islands_USA }}</option>
          <option value="{{ $static_bookingFormLand2->Wake_Island }}">{{ $static_bookingFormLand2->Wake_Island }}</option>
          <option value="{{ $static_bookingFormLand2->Wallis_Futana_Is }}">{{ $static_bookingFormLand2->Wallis_Futana_Is }}</option>
    ...
    <div class="col-md-6">
      <div class="form-group">
        <label>{{ $static_bookingForm->form_check_text }}
          <a href="#" title="{{ $static_bookingForm->form_check_title }}" data-toggle="popover" data-placement="top" data-trigger="hover"
            data-content="{{ $static_bookingForm->form_check_data_content }}">
    ...
    <div class="col-md-6">
      <div class="form-group">
        <label>{{ $static_bookingForm->guest_text }}
          <a href="#" title="{{ $static_bookingForm->guest_title }}" data-toggle="popover" data-placement="top" data-trigger="hover"
            data-content="{{ $static_bookingForm->guest_data_content }}">
            <i class="fa {{ $static_bookingForm->guest_i_class }}"></i>
          </a>
        </label>
        <div class="panel-dropdown">
          <div class="form-control guestspicker">{{ $static_bookingForm->dropdown_text }}
          ...
          <div class="panel-dropdown-content">
            ...
            <div class="guests-buttons">
              <label>{{ $static_bookingForm->dropdown_children_text }}
                <a href="#" title="" data-toggle="popover" data-placement="top" data-trigger="hover"
                  data-content="{{ $static_bookingForm->dropdown_children_data_content }}" data-original-title="Children">
    ...
    <div class="col-md-12">
      <div class="form-group">
        ...
        <select name="booking-roomtype" class="form-control" title="{{ $static_bookingForm->room_type_select_title }}" data-header="{{ $static_bookingForm->room_type_select_data_header }}">
          <option value="Single Room" data-subtext="<span class='badge badge-info'>€89 / night</span>">
            Single Room
          </option>
          <option value="Double Room" data-subtext="<span class='badge badge-info'>€129 / night</span>">
            Double Room</option>
          <option value="Deluxe Room" data-subtext="<span class='badge badge-info'>€89 / night</span>">
            Deluxe Room</option>
        </select>
      </div>
    </div>
    <div class="col-md-12">
      <div class="form-group">
        ...
        <textarea class="form-control" name="booking-comments" placeholder="{{ $static_bookingForm->comment_placeholder }}"></textarea>
      </div>
    </div>
    <div class="col-md-12">
