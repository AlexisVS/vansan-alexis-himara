...
class PageHomeBookingFormSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('page_home_booking-forms')->insert([
            ...
            'roomtype_select_option1_value' => 'Single',
            'roomtype_select_option1_text' => 'Single Room',
            'roomtype_select_option2_value' => 'Double',
            'roomtype_select_option2_text' => 'Double Room',
            'roomtype_select_option3_value' => 'Deluxe',
            'roomtype_select_option3_text' => 'Deluxe Room',
