...
class PageBookingFormSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('page_booking_forms')->insert([
            ...
            'room_type_option1_value' => 'Single Room',
            'room_type_option1_data_subtext' => "<span class='badge badge-info'>€89 / night</span>",
            'room_type_option1_text' => 'Single Room',
            'room_type_option2_value' => 'Double Room',
            'room_type_option2_data_subtext' => "<span class='badge badge-info'>€129 / night</span>",
            'room_type_option2_text' => 'Double Room',
            'room_type_option3_value' => 'Deluxe Room',
            'room_type_option3_data_subtext' => "<span class='badge badge-info'>€89 / night</span>",
            'room_type_option3_text' => 'Deluxe Room',
